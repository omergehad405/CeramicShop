  ...
  return (
    <div className="my-[8rem] px-10 ">
      <div className="w-[70%] mx-auto md:w-full">
        ...
        <h1 className="text-main leading-snug text-5xl md:text-3xl">
      ...
      <div className="w-[70%] md:w-full mx-auto flex md:flex-col items-center justify-evenly gap-5 mt-20">
        ...
        <div className="w-[50%] md:w-full ">
          ...
          <h1 className="text-main w-[550px] md:w-full leading-snug text-2xl md:text-xl py-5">
            Welcome to Ceramic Shop, where passion meets craftsmanship to bring
            you a world of timeless beauty and creativity.
          </h1>
          <p className="text-gray-500 pb-5 w-[500px] md:w-full">
            Our journey is steeped in the art of ceramics, where each piece
            tells a unique story. Get to know the heart and soul behind
            our store.
          </p>
